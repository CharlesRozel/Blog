...
A page in the perfect book should be overlaid, notionally, with a 9 x 9 grid so that the width is made up of 9 rows of 9 equal rectagles and the height is made up of 9 rows of 9 equal rectangles.
...
\documentclass[twoside,openrecto]{book}
